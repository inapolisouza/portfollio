...
export default function Certifications() {
  return (
    <section id="certificacoes" className="py-16 md:py-24 bg-dark-light">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {certifications.map((cert) => (
            <div
              key={cert.id}
              className="bg-dark border border-gray-800 rounded-lg overflow-hidden hover:border-primary/50 transition-colors"
            >
              <div className="relative w-full bg-white flex items-center justify-center py-4">
                <Image
                  ...
                  width={600}
                  height={400}
                  className="w-full h-auto object-contain max-h-[280px] md:max-h-[300px]"
